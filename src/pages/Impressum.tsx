      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
            ...
            <Card className="shadow-lg">
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <p className="text-gray-700">easy2heat GmbH</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">DE924506774</p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">info@knobloch-heizoel.de</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="shadow-lg mb-8">
            ...
            <CardContent>
              <p className="text-gray-700">Marco Knobloch</p>
            </CardContent>
          </Card>
