        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="shadow-lg mb-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700 text-sm leading-relaxed">
                Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (easy2heat GmbH, Gollierstraße 70/D, 80339 München, E-Mail: info@knobloch-heizoel.de, Tel.: 089 244 189 180) mittels einer eindeutigen Erklärung (z.B. ein mit der Post versandter Brief, Telefax oder E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren.
              </p>
              
              <div className="bg-primary-50 p-4 rounded-lg">
                <h3 className="font-semibold text-gray-900 mb-2">Kontakt für Widerruf:</h3>
                <div className="space-y-1 text-gray-700 text-sm">
                  <p><span className="font-semibold">Adresse:</span> easy2heat GmbH, Gollierstraße 70/D, 80339 München</p>
                  <p><span className="font-semibold">E-Mail:</span> info@knobloch-heizoel.de</p>
            ...
            <CardContent>
              <div className="bg-gray-50 p-6 rounded-lg border">
                ...
                <div className="space-y-4 text-gray-700 text-sm">
                  <p>An: easy2heat GmbH, Gollierstraße 70/D, 80339 München, E-Mail: info@knobloch-heizoel.de</p>
